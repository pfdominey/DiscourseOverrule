...
plt.subplot(131)
plt.hist(A, 8, alpha=0.5, label='Expected')
plt.hist(B, 8, alpha=0.5, label='Related')
plt.hist(C, 8, alpha=0.5, label='Unrelated')
...
plt.subplot(132)
plt.hist(D, 8, alpha=0.5, label='Expected')
plt.hist(E, 8, alpha=0.5, label='Related')
plt.hist(F, 8, alpha=0.5, label='Unrelated')
...
# Show the graph
plt.savefig('Metusalem-1-Res-Hist-combined.png')
plt.show()
